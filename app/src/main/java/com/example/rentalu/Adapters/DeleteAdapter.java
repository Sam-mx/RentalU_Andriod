...
public class DeleteAdapter extends RecyclerView.Adapter<DeleteAdapter.ViewHolder> {
    ...
    public DeleteAdapter(ArrayList<PropertyModel> PropertyModelArrayList,Context context) {
    ...
    public DeleteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        DeleteAdapter.ViewHolder viewHolder=new DeleteAdapter.ViewHolder(listItem);
        return viewHolder;
    }
